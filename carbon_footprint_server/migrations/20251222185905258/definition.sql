...
--
-- Class ActionLog as table action_log
--
...
--
-- Class ButlerEvent as table butler_event
--
...
--
-- Class Challenge as table challenge
--
...
--
-- Class CommunityGroup as table community_group
--
...
--
-- Class EcoAction as table eco_action
--
...
--
-- Class SocialPost as table social_post
--
...
CREATE TABLE "user_profile" (
    ...
    "monthlyBudget" double precision NOT NULL DEFAULT 200.0,
    "userName" text
);
...
--
-- Foreign relations for "action_log" table
--
...
--
-- Foreign relations for "challenge" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('carbon_footprint', '20251222185905258', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251222185905258', "timestamp" = now();
